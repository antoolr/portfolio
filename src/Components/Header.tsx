...
const products = [
  { name: 'Moviles', description: 'Get a better understanding of your traffic', href: '#', icon: ChartPieIcon },
  { name: 'Tablets', description: 'Speak directly to your customers', href: '#', icon: CursorArrowRaysIcon },
  { name: 'Ordenadores', description: 'Your customers’ data will be safe and secure', href: '#', icon: FingerPrintIcon },
  { name: 'Portatiles', description: 'Connect with third-party tools', href: '#', icon: SquaresPlusIcon },
